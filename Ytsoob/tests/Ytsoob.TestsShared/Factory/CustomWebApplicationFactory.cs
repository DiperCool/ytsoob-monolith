...
namespace Ytsoob.TestsShared.Factory;

public class CustomWebApplicationFactory : WebApplicationFactory<YtsoobApiMetadata>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services => { TestConfigureServices?.Invoke(services); });
