...
public class Ytsoober : Aggregate<long>
{
    ...
    protected Ytsoober(){}
    protected Ytsoober(long id, Username username, Email email, string identityId)
    {
        Id = id;
        Email = email;
    ...
    public static Ytsoober Create(long id, Username username, Email email, string identityId)
    {
