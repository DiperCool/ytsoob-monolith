...
using Ytsoob.Shared.Resiliency.Options;

namespace Ytsoob.Shared.Resiliency.Extensions;
            ...
            (sp, registry) =>
            {
                ...
                var retryPolicy =
                    ...
                    Policy
                        ...
                        .WaitAndRetryAsync(
                            ...
                            retryAttempt =>
                                TimeSpan.FromSeconds(Math.Pow(policyOptions.RetryPolicyOptions.BackoffPower,
                                    retryAttempt)),
                ...
                var circuitBreakerPolicy = Policy
                    ...
                    .CircuitBreakerAsync(
                        ...
                        onReset: context => { context.GetLogger()?.LogWarning("Circuit breaker reset"); }
                    );
                ...
                registry.Add(PolicyNames.Timeout,
                    timeoutPolicy); // We place the timeoutPolicy inside the retryPolicy, to make it time out each try.
